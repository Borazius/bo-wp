...
<head>
    ...
    <title>Bora Önal - Web-Spezialist / Web-Entwickler / Region Pforzheim, Stuttgart, Karlsruhe</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="Entwicklung von Webseiten für alle Endgeräte mit Mehrwert für Ihre Kunden vom Web-Profi aus Pforzheim">
    <meta name="keywords" content="Freelancer, Pforzheim, Web-Entwickler, Karlsruhe, Web-Spezialist, Stuttgart">
    <meta name="author" content="BoOe" />
	...
	<!--[if lt IE 8]><!-->
	<link rel="stylesheet" href="<?php bloginfo('template_url');?>/css/icomoon-ie7.css" type="text/css">
    <!--<![endif]-->
    ...
    <div id="page" class="page">
        ...
        <div class="mobile-header mobile-visible">
            <div class="mobile-logo-container">
                <div class="mobile-site-title">Bora Önal</div>
            </div>
