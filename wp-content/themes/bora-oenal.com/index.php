                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div id="map" class="map">
                                    <script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=	AIzaSyDSf41K5tEZIFPiUKaWOYsmv2n7pDl1mVM'></script>
                                    <div style='overflow:hidden;height:210px;width:400px;'>
                                    ...
                                    <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=f45ba0cd872ad5ac4de6bf45935e67eaeb78c38a'></script>
                                    <script type='text/javascript'>
                                        function init_map() {
                                            var myOptions = {
                                                zoom: 15,
                                                center: new google.maps.LatLng(48.8811223, 8.7166919),
                                                mapTypeId: google.maps.MapTypeId.ROADMAP
                                            };
                                            map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);
                                            marker = new google.maps.Marker({
                                                map: map,
                                                position: new google.maps.LatLng(48.8811223, 8.7166919)
                                            });
                                            infowindow = new google.maps.InfoWindow({
                                                content: '<strong>Standort</strong><br>'
                                            });
                                ...
                                <div class="contact-info-block">
                                    ...
                                    <div class="ci-text">
                                        <h5>Pforzheim, Baden Württemberg</h5>
                                    </div>
                                </div>
                                <div class="contact-info-block">
                                    <div class="ci-icon">
