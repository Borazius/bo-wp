                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8">
                                        <div class="title-block">
                                            ...
                                            <div class="owl-carousel text-rotation">
                                                <div class="item">
                                                    <div class="sp-subtitle">Web-Entwickler </div>
                                                </div>
                                            </div>
                                            <div class="job">
                                                <span class="jobtitel">Dipl. Wirtschaftsinformatiker (FH) </span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="about-me">
                                            ...
                                            <p>Hallo! Ich bin Bora Önal, freier Web-Entwickler aus Pforzheim. Seit über 				10 Jahren helfe ich Unternehmen Ihre Web-Ideen zu realiseren. Meine Mission ist es das World Wide Web täglich schöner und qualitativ besser zu gestalten.</p>
                                        </div>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <ul class="info-list">
                                            <li>
                                                <span class="title">Jahrgang</span>
                                                <span class="value">1976</span>
                                            </li>
                                            <li>
                                                <span class="title">Wohnort</span>
                                                <span class="value">Deutschland</span>
                                            </li>
                                            <li>
                                                <span class="title">Adresse</span>
                                                <span class="value">Birkenfeld, Deutschland</span>
                                            </li>
                                            <li>
                                                <span class="title">e-mail</span>
                                                <span class="value">
                                                    <a href="mailto:bora@webmundo.de">info@boraoenal.com</a>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="title">Mobile</span>
                                                <span class="value">+176 64 34 34 12</span>
                                            </li>
                                            <li>
                                        ...
                                        <div class="block">
                                            ...
                                            <div class="timeline">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <p class="item-description">Begleiter von Großkonzernen und mittelständischen Unternehmen bei der Digital Business Transformation. Frontend-Development in agilen Projekten</p>
                                                </div>
                                                <!-- / Experience 1 -->
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <p class="item-description">Mauris magna sapien, pharetra consectetur fringilla vitae, interdum sed
                                                        tortor.</p>
                                                </div>
                                                <!-- / Experience 2 -->
                                ...
                                <div class="row">
                                        ...
                                        <div class="service-block">
                                            <div class="service-info">
                                                ...
                                                <div class="service-image">
                                                    <img src="<?php bloginfo('template_url');?>/images/service/web_design_icon.png" alt="Responsive Design" class="mCS_img_loaded">
                                                </div>
                                                <h4>Web Design</h4>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="service-block">
                                            <div class="service-info">
                                                <div class="service-image">
                                                    <img src="<?php bloginfo('template_url');?>/images/service/photography_icon.png" alt="Photography" class="mCS_img_loaded">
                                                </div>
                                                <h4>Photography</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor.</p>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="service-block">
                                            <div class="service-info">
                                                <div class="service-image">
                                                    <img src="<?php bloginfo('template_url');?>/images/service/creativity_icon.png" alt="Creativity" class="mCS_img_loaded">
                                                </div>
                                                <h4>Management</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor.</p>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="service-block">
                                            <div class="service-info">
                                                <div class="service-image">
                                                    <img src="<?php bloginfo('template_url');?>/images/service/advetising_icon.png" alt="Advetising" class="mCS_img_loaded">
                                                </div>
                                                <h4>Advetising</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor.</p>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="col-sm-4 col-md-2 subpage-block">
                                            <div class="client-block">
                                                <a href="#" target="_blank">
                                                    <img src="<?php bloginfo('template_url');?>/images/clients/client_2.png" alt="image" class="mCS_img_loaded">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-md-2 subpage-block">
                                            <div class="client-block">
                                                <a href="#" target="_blank">
                                                    <img src="<?php bloginfo('template_url');?>/images/clients/client_3.png" alt="image" class="mCS_img_loaded">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-md-2 subpage-block">
                                            <div class="client-block">
                                                <a href="#" target="_blank">
                                                    <img src="<?php bloginfo('template_url');?>/images/clients/client_4.png" alt="image" class="mCS_img_loaded">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-md-2 subpage-block">
                                            <div class="client-block">
                                                <a href="#" target="_blank">
                                                    <img src="<?php bloginfo('template_url');?>/images/clients/client_5.png" alt="image" class="mCS_img_loaded">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-md-2 subpage-block">
                                            <div class="client-block">
                                                <a href="#" target="_blank">
                                                    <img src="<?php bloginfo('template_url');?>/images/clients/client_6.png" alt="image" class="mCS_img_loaded">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="testimonials owl-carousel block">
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <div class="testimonial-content">
                                                    <div class="testimonial-text">
                                                        <p>"Aliquam congue auctor lectus sed fermentum. Nulla ultricies tellus
                                                            quis sapien lacinia egestas."</p>
                                                    </div>
                                                </div>
                                                <!-- /Testimonial Content -->
                                            </div>
                                ...
                                <div class="portfolio-content">
                                    ...
                                    <div id="portfolio_grid" class="portfolio-grid portfolio-masonry masonry-grid-3">
                                        ...
                                        <figure class="item" data-groups='["all","illustration"]'>
                                            <a href="<?php bloginfo('template_url');?>/images/portfolio/full/3.jpg" class="lightbox" title="Duis Eu Eros Viverra">
                                ...
                                <div class="blog-masonry two-columns">
                                        ...
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_1.jpg" alt="blog-post-1" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_2.jpg" alt="blog-post-2" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_3.jpg" alt="blog-post-3" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_4.jpg" alt="blog-post-4" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_5.jpg" alt="blog-post-5" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_6.jpg" alt="blog-post-6" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_7.jpg" alt="blog-post-7" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
                                    ...
                                    <div class="item">
                                        <div class="blog-card">
                                            <div class="media-block">
                                                <a href="blog-post-1.html">
                                                    <img class="post-image img-responsive" src="<?php bloginfo('template_url');?>/images/blog/blog_post_8.jpg" alt="blog-post-8" />
                                                    <div class="mask"></div>
                                                    <div class="post-date">
